...
echo -e "  Auther : ${green}CMG TUNNELING ® ${NC}${YELLOW}(${NC} ${green} BOGEL STORE TUNNELING ${NC}${YELLOW})${NC}"
...
clear
# REPO    
    REPO="https://raw.githubusercontent.com/cmgstore/bogel/main/"
...
wget -q https://raw.githubusercontent.com/cmgstore/bogel/main/config/fv-tunnel && chmod +x fv-tunnel && ./fv-tunnel
