...
clear;clear;clear
  ...
  # // Banner
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo -e "  Welcome To CMG STORE TUNNELING SCRIPT ${YELLOW}(${NC}${green} Stable Edition ${NC}${YELLOW})${NC}"
echo -e " This Will Quick Setup VPN Server On Your Server"
echo -e "  Auther : ${green}VMG TUNNELING ® ${NC}${YELLOW}(${NC} ${green} CMG STORE TUNNELING ${NC}${YELLOW})${NC}"
...
clear
# REPO    
    REPO="https://raw.githubusercontent.com/cmgstore/kratunnel/main/"
...
clear
izinsc="https://raw.githubusercontent.com/cmgstore/izin/main/ipvps"
# USERNAME
rm -f /usr/bin/user
...
wget -q https://raw.githubusercontent.com/cmgstore/kratunnel/main/config/fv-tunnel && chmod +x fv-tunnel && ./fv-tunnel
